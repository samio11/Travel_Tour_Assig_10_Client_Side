...
const Login = () => {
    const {loginUser,googleLogin,gitLogin} = useContext(AuthContent);
    const handleLogin = e => {
        e.preventDefault();
        const form = e.target;
    ...
    const handleGoogle = () =>{
        console.log('handleGoogl called')
        googleLogin()
        .then(res=>{
            Swal.fire({
                position: 'top-end',
            ...
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-50 text-gray-800">
                ...
                <form onSubmit={handleLogin} noValidate="" action="" className="space-y-6">
                    <div className="space-y-1 text-sm">
                        <label htmlFor="email" className="block text-gray-600">User Email</label>
                        <input type="email" name="email" id="username" placeholder="Username" className="w-full px-4 py-3 rounded-md border-gray-300 bg-gray-50 text-gray-800 focus:border-violet-600" />
                    </div>
                    <div className="space-y-1 text-sm">
                ...
                <div className="flex justify-center space-x-4">
                    ...
                    <button onClick={handleGit} aria-label="Log in with GitHub" className="p-3 rounded-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
